...
echo '<div class="set-box">
	<a href = "' . get_site_url() . '/' . $site_name . '/">
	<img src = "' . get_site_url() . '/wp-content/uploads/set_symbols/' . $icon_name . '">
	<br>' . $set_name . '</a><br>
...
set_box("Hour of Devastation", "hour-of-devastation", "Hour-of-Devastation-Symbol.png");
set_box("Amonkhet", "amonkhet", "Amonkhet-Symbol.png");
